...
#define E0_DIAG_PIN                         PF4   // E0DET
#define E1_DIAG_PIN                         PF5   // E1DET
...
//
  ...
  #if X_HOME_TO_MIN
    #define X_MAX_PIN                       PF4   // E0DET
  #else
    #define X_MIN_PIN                       PF4   // E0DET
  #endif
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                       PF5   // E1DET
  #else
    #define Y_MIN_PIN                       PF5   // E1DET
  #endif
  ...
  #if Z_HOME_TO_MIN
    #define Z_MAX_PIN                       PE12  // PWRDET
  #else
    #define Z_MIN_PIN                       PE12  // PWRDET
  #endif
...
//
  ...
  #define FIL_RUNOUT_PIN                    PF4  // E0DET
#endif
#ifndef FIL_RUNOUT2_PIN
  #define FIL_RUNOUT2_PIN                   PF5  // E1DET
#endif
...
//
  ...
  #define POWER_LOSS_PIN                    PE12  // Power Loss Detection: PWR-DET
#endif

//
// Steppers
//
#define X_STEP_PIN                          PF9
...
//
#ifndef HEATER_0_PIN
  #define HEATER_0_PIN                      PE11  // Heater0
#endif
#ifndef HEATER_1_PIN
  #define HEATER_1_PIN                      PE13  // Heater1
#endif
#ifndef HEATER_BED_PIN
  #define HEATER_BED_PIN                    PB3   // Hotbed
#endif
#ifndef FAN0_PIN
  #define FAN0_PIN                          PD15  // Fan0
    ...
    #define SPINDLE_LASER_PWM_PIN           PD13
  #endif
  #ifndef SPINDLE_LASER_ENA_PIN
    #define SPINDLE_LASER_ENA_PIN           PD14
  #endif
#else
  #ifndef FAN1_PIN
